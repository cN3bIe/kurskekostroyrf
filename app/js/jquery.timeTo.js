        ...
        return this.each(function() {
            ...
            if(!data.vals || method === 'reset') { // new clock
                ...
                if(data.displayDays > 0) {
                    ...
                    thtml = (data.displayCaptions ?
                        '<figure style="width:'+ Math.round(data.width*data.displayDays + marginRight + 4) +'px">$1<figcaption style="font-size:'+ captionSize +'px; padding-right:'+ Math.round(marginRight) +'px">'+ dictionary[data.lang].days +'</figcaption></figure>'+ dot2
                        : '$1').replace(
                            /\$1/, dhtml
                        ) + thtml;
                }
